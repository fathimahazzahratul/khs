...
class aksi_pagu_kontrak extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model('m_aksi_pagu_kontrak');
    }

    public function index()
    {
        $data['aksi_kontrak'] = $this->m_aksi_pagu_kontrak->edit('tb_pagu_kontrak')->result();
    ...
    public function edit_crud_area($VENDOR_ID)
    {
        $where = array('VENDOR_ID' => $VENDOR_ID);
        $data['aksi_pagu_kontrak'] = $this->m_aksi_pagu_kontrak->edit_data($where, 'tb_pagu_kontrak')->result();
