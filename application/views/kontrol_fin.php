                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php echo anchor('kontrol_fin/aksi_pagu_kontrak/' . $kf->tahun, '<div><a href="aksi_pagu_kontrak">Edit</a></div>') ?></td>
                                            <td><?php echo anchor('kontrol_fin/aksi_pagu_rating/' . $kf->tahun, '<div><a href="aksi_pagu_rating">Edit</a></div>') ?></td>
                                        </tr>
                                    <?php } ?>
